...
export declare class PaginatedTransactions extends Message<PaginatedTransactions> {
  /**
   * @generated from field: repeated rc.loyalty.type.v1.Transaction transactions = 1;
   */
  ...
  static readonly typeName = "rc.loyalty.type.v1.PaginatedTransactions";
...
export declare class Transactions extends Message<Transactions> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "rc.loyalty.type.v1.Transactions";
  static readonly fields: FieldList;
...
export declare class Transaction extends Message<Transaction> {
  ...
  /**
   * @generated from field: rc.loyalty.type.v1.TransactionType transaction_type = 2;
   */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "rc.loyalty.type.v1.Transaction";
  static readonly fields: FieldList;
